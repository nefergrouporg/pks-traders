      ...
      <div className="p-6 max-h-[90vh] overflow-y-auto w-full max-w-4xl">
        ...
        {activeTab === 'details' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-sm font-medium text-gray-500">Last Purchase Date</h3>
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">Last Purchase Amount</h3>
                <p className="text-base">
              ...
              <div>
                <h3 className="text-sm font-medium text-gray-500">Debt Amount</h3>
                <p className={`text-base ${customer.debtAmount > 0 ? 'text-red-600 font-semibold' : ''}`}>
